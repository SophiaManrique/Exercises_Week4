...
#same thing as: flights$delated_in_air = flights$arr_delay - flights$dep_delay
View(flights)
...
#to sort in descending order: arrange(flights, -delayed_in_air)
...
# origin, destination, and the "delayed_in_air" column you just created
